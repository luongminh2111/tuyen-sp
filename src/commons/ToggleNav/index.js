...
function ToggleNav(props) {
  ...
  return (
    <div className={`toggle-menu-wrapper ${isExpand ? "expand" : ""}`}>
      ...
      <div className="menu-item issue d-flex" onClick={() => history.push("/issue")}>
        <span className="icon">
      ...
      <div className="menu-item file d-flex" onClick={() => history.push("/file")}>
        <span className="icon">
          <i class="fa-solid fa-folder"></i>
        </span>
        {isExpand ? <span className="text">Files</span> : null}
      </div>
      <div className="menu-item setting d-flex" onClick={() => history.push("/setting")}>
        <span className="icon">
